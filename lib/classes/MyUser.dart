...
//<editor-fold desc="Data Methods" defaultstate="collapsed">
  ...
  @override
  String toString() {
    return 'MyUser{id: $id, name: $name, email: $email, phoneNumber: $phoneNumber, token: $token, usersType: $usersType}';
  }
  ...
  factory MyUser.fromMap(Map<String, dynamic> map) {
    return new MyUser(
      ...
      usersType: map['usersType'] as UsersType?,
    );
  }
  ...
  Map<String, dynamic> toMap() {
    ...
    return {
      ...
      'token': this.token,
      'usersType': this.usersType ?? UsersType.None.index.toString(),
